---
title: "Solutions to Homework for Week 1"
...
```{r include=FALSE}
library(RPostgres)
con <- dbConnect(RPostgres::Postgres(), host="localhost", dbname="Zoomcamp", password = "haanuel", user = "postgres")
```

## Pre-processing steps

The following pre processing steps were done to make analysis easier.

![](C:/Users/Admin/AppData/Local/RStudio/tmp/paste-22F3FF16.png){width="250"}

## Solutions

### How many taxi trips were there on January 15th?
...
SELECT v_date, COUNT(*) no_of_trips
FROM jan_15
GROUP BY 1
...
SELECT DATE(tpep_pickup_datetime) trip_date, tip_amount
FROM yellow_taxi_data
WHERE tip_amount = (
